...
function Section({ minHeight, setActiveTab, activeTab }) {
  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        backgroundImage: "url(images/bgtab2.png)",
        ...
        <div className="grid grid-cols-2 gap-4 pl-32 pr-32">
          ...
          <div className=" col-span-1 p-4">
            <div className="flex items-start">
              ...
              <div className="text-white text-xl  font-unbounded  ml-2 font-normal text-left">
                Con tu aporte <strong>SEÑAL</strong> estás apoyando a Fundación
                Antenna en el desarrollo de nuevos proyectos que benefician a
                artistas y espacios culturales.
              </div>
            </div>
          </div>
          <div className=" col-span-1 p-4">
            <p className="text-white text-xl  font-unbounded  ml-10 font-normal ">
              SEÑAL es presentado por BTG Pactual, organización que ha mantenido
              durante décadas un fuerte compromiso con diversas iniciativas
              culturales y artísticas, así como con la promoción del debate y
              reflexión en torno a ideas como una forma de contribuir a nuestra
              comunidad.
            </p>
          </div>
        </div>
