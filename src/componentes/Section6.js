      ...
      <div className="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-24 lg:px-6 ">
        ...
        <div className="max-w-screen-md mx-auto">
          ...
          >
            ...
            <AcordeonTab titulo={'¿Cuáles son los horarios?'} contenido={'Nuestros encuentros empiezan a las 19:30 hrs. y tienen una duración de 2 horas. Se hacen en días de semana.'} />
