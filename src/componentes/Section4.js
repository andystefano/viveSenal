...
<p className='mx-auto hidden sd:block sm:block lg:block xl:block text-base sd:text-4xl md:text-4xl lg:text-4xl  xl:text-4xl text-center font-unbounded  px-10 py-20'>CON TU APORTE <span className='font-bold'>SEÑAL</span> ESTÁS APOYANDO A<br/>
...
<p className='mx-auto text-base block sd:hidden  sm:hidden  lg:hidden  xl:hidden  sd:text-4xl md:text-4xl lg:text-4xl  xl:text-4xl text-center font-unbounded  px-10 py-20'>CON TU APORTE <span className='font-bold'>SEÑAL</span> ESTÁS APOYANDO A
&nbsp;<span className='font-bold'>FUNDACIÓN ANTENNA</span> EN EL DESARROLLO<br/>
DE NUEVOS PROYECTOS QUE BENEFICIAN A<br/>
ARTISTAS Y ESPACIOS CULTURALES.</p>
