  ...
  return (
    <header className=" w-full px-7 py-7">
      <nav className="bg-black border-gray-200 py-2.5 dark:bg-gray-900">
        <div className="flex flex-wrap items-start justify-between px-4 mx-auto">
          ...
          <div className="flex items-center lg:order-2">
            ...
            >
              <img className="h-6 mr-3 sm:h-14" alt="Señal es presentado por BTG Pactual" src="images/btlLogoTop.png" />
            </a>
            <button
