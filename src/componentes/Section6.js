      ...
      <div className="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-24 lg:px-6 ">
        ...
        <div className="max-w-screen-md mx-auto">
          ...
          >
            ...
            <AcordeonTab titulo={'¿Qué ocurre en los encuentros SEÑAL?'} contenido={'Cada experiencia SEÑAL está pensada en tres momentos: una conversación que te llevará a conocer más a los artistas y creadores de lo que estás viendo, una sesión musical en vivo y una activación de nuestras marcas colaboradoras para que compartas y disfrutes de estas instancias únicas.'} />
