            ...
            <div className="text-white p-4 rounded-lg">
              <div className="w-full lg:w-10/12 sd:w-full mt-2">
                <p className="text-[1rem] leading-6 sd:text-base md:text-base lg:text-base xl:text-base text-white mb-4 font-libre-franklin text-center sm:text-left lg:text-left xl:text-left">
                  Una señal es un llamado, un signo, una forma de transmitir información. También
                  es el nombre de una nueva experiencia que te invita a conocer Santiago, el mundo
                  del arte y la cultura&nbsp;
                  <strong>a través de conversaciones cercanas y música experimental.</strong>
                </p>
                <p className="text-[1rem] leading-6 sd:text-base md:text-base lg:text-base xl:text-base text-white mb-4 font-libre-franklin text-center sm:text-left lg:text-left xl:text-left">
